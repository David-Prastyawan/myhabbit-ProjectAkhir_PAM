...
import com.myhabbit.adapter.DaftarAdapter;
import com.myhabbit.database.DaftarController;

import java.util.ArrayList;
import java.util.List;

public class DaftarWirid extends AppCompatActivity implements DaftarAdapter.OnDaftarClickListener {
    public RecyclerView rv;
    public DaftarAdapter daftarAdapter;
    public RecyclerView.LayoutManager layoutManager;
    public List<DaftarController> listDaftarController = new ArrayList<>();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_daftar_wirid);

        rv = findViewById(R.id.rvList);

        // Isti'adzah
        listDaftarController.add(new DaftarController(
                "[1] Isti'adzah",
                "( Dibaca 1x )",
        ...
        daftarAdapter = new DaftarAdapter(listDaftarController);
    ...
    public void onClick(View view, int position) {
        DaftarController daftarController = listDaftarController.get(position);
        Toast.makeText(this, daftarController.getSurah(), Toast.LENGTH_LONG).show();
    }
}